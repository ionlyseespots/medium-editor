    ...
    Toolbar = Extension.extend({
        ...
        showToolbar: function () {
            ...
            if (!this.isDisplayed()) {
                ...
                if (typeof this.getEditorOption('onShowToolbar') === 'function') {
                    Util.deprecated('onShowToolbar', 'the showToolbar custom event', 'v5.0.0');
                    this.getEditorOption('onShowToolbar')();
                }
            }
        },
        ...
        hideToolbar: function () {
            if (this.isDisplayed()) {
                ...
                if (typeof this.getEditorOption('onHideToolbar') === 'function') {
                    Util.deprecated('onHideToolbar', 'the hideToolbar custom event', 'v5.0.0');
                    this.getEditorOption('onHideToolbar')();
                }
            }
        },
